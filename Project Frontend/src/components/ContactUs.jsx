...
import { sendFeedback } from "@/features/UserSlice";
    ...
    <section className="mt-32">
      <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
        <div className="text-center px-6">
          <h2 className="text-violet-600 text-3xl font-extrabold">
            Contact Us
          </h2>
        ...
        <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
          <div className="bg-violet-600 rounded-lg p-6 h-full max-lg:order-1">
            ...
            <ul className="flex flex-wrap gap-4 mt-16">
              <li className="bg-white hover:bg-slate-100 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid sm:grid-cols-2 gap-8">
                ...
                <div className="col-span-full">
                  <h6 className="text-md font-semibold text-violet-600">
                    Select Subject
                  </h6>
                  <div className="flex max-lg:flex-col gap-6 mt-4">
                    <label className="flex items-center gap-3 cursor-pointer text-gray-500 text-[17px]">
                      <span
                      ...
                      >
                        <input
                          ...
                          onChange={() => {
                            setSelectedSubject("general_inquiry");
                            setFormData({...formData, subject: "general_inquiry"})
                          }}
                   ...
                   ${selectedSubject === "general_inquiry" ? "scale-100" : ""}
                `}
                        ></span>
                      </span>
                      General Inquiry
                    ...
                    <label className="flex items-center gap-3 cursor-pointer text-gray-500 text-[17px]">
                      <span
                        className={`relative w-5 h-5 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 ${
                          selectedSubject === "technical_support"
                            ? "border-violet-600 bg-violet-100"
                            : ""
                        }`}
                      >
                        <input
                          ...
                          className="absolute inset-0 opacity-0 cursor-pointer"
                          onChange={() => {
                            setSelectedSubject("technical_support");
                            setFormData({...formData, subject: "technical_support"})
                          }}
                          checked={selectedSubject === "technical_support"}
                        />
                        <span
                          className={`block w-3 h-3 rounded-full transition-transform transform scale-0 bg-violet-600
                   ${selectedSubject === "technical_support" ? "scale-100" : ""}
                `}
                        ></span>
                      </span>
                      Technical Support
                    ...
                    <label className="flex items-center gap-3 cursor-pointer text-gray-500 text-[17px]">
                      <span
                        className={`relative w-5 h-5 rounded-full border-2 border-gray-300 flex items-center justify-center transition-all duration-300 ${
                          selectedSubject === "website_feedback"
                            ? "border-violet-600 bg-violet-100"
                            : ""
                        }`}
                      >
                        <input
                          ...
                          className="absolute inset-0 opacity-0 cursor-pointer"
                          onChange={() => {
                            setSelectedSubject("website_feedback");
                            setFormData({...formData, subject: "website_feedback"})
                          }}
                          checked={selectedSubject === "website_feedback"}
                        />
                        <span
                          className={`block w-3 h-3 rounded-full transition-transform transform scale-0 bg-violet-600
                   ${selectedSubject === "website_feedback" ? "scale-100" : ""}
                `}
                        ></span>
                      </span>
                      Website Feedback
              ...
              <button
                type="submit"
                className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-violet-600 hover:bg-violet-700"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
